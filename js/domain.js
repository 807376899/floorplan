(function attachFloorplanDomain(global) {
  ...
  function normalizeSpace(row) {
    ...
    return {
      ...
      space_name: row.space_name || row.space_code,
      length_m: length,
      width_m: width,
  ...
  function sampleDataset() {
    return {
      ...
      spaces: [
        { space_code: "101", building_code: "B01", floor_code: "1", segment_code: "main", offset_m: 0, side: "north", front_door: "101", rear_door: "", space_name: "101实验室", length_m: 9.6, width_m: 7.2, network_segment: "192.168.1.0/24", current_status: "active" },
        { space_code: "102", building_code: "B01", floor_code: "1", segment_code: "main", offset_m: 15, side: "south", front_door: "102", rear_door: "104", space_name: "102-104实验室", length_m: 11.2, width_m: 7, network_segment: "192.168.2.0/24", current_status: "active" },
        { space_code: "108", building_code: "B01", floor_code: "1", segment_code: "branch", offset_m: 6, side: "east", front_door: "108", rear_door: "110", space_name: "AI联合实验室", length_m: 10, width_m: 6, network_segment: "VLAN-118", current_status: "active" },
        { space_code: "201", building_code: "B01", floor_code: "2", segment_code: "loop-north", offset_m: 8, side: "north", front_door: "201", rear_door: "", space_name: "201实验室", length_m: 9, width_m: 6.8, network_segment: "192.168.3.0/24", current_status: "active" },
        { space_code: "202", building_code: "B01", floor_code: "2", segment_code: "loop-east", offset_m: 7, side: "east", front_door: "202", rear_door: "204", space_name: "202实验室", length_m: 12, width_m: 7, network_segment: "192.168.4.0/24", current_status: "reserved" },
        { space_code: "A-101", building_code: "B02", floor_code: "1", segment_code: "zig-1", offset_m: 6, side: "north", front_door: "A101", rear_door: "A103", space_name: "化学实验室", length_m: 12, width_m: 7.8, network_segment: "10.10.10.0/24", current_status: "active" },
        { space_code: "A-104", building_code: "B02", floor_code: "1", segment_code: "zig-3", offset_m: 5, side: "south", front_door: "A104", rear_door: "A106", space_name: "生物实验室", length_m: 11, width_m: 7, network_segment: "10.10.20.0/24", current_status: "active" },
      ],
      labs: [
  ...
  function templateRows(key) {
    return {
      ...
      spaces: [{ space_code: "101", building_code: "B01", floor_code: "1", segment_code: "main", offset_m: 0, side: "north", front_door: "101", rear_door: "", space_name: "101实验室", length_m: 9.6, width_m: 7.2, network_segment: "192.168.1.0/24", current_status: "active" }],
